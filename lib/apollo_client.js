...
var ApolloHttpClient = /** @class */ (function () {
    function ApolloHttpClient(_a) {
        var uri = _a.uri, fetch = _a.fetch, token = _a.token, debug = _a.debug, wsUri = _a.wsUri, wsImpl = _a.wsImpl, anonWs = _a.anonWs, httpServers = _a.httpServers;
