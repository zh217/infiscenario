...
class ApolloHttpClient {
    ...
    queryGql(query, variables, options) {
        return __awaiter(this, void 0, void 0, function* () {
            variables = variables || {};
            options = options || {};
            return yield this.client.query(Object.assign({}, options, { query, variables }));
        });
    }
    mutateGql(mutation, variables, options) {
        return __awaiter(this, void 0, void 0, function* () {
            variables = variables || {};
            options = options || {};
            return yield this.client.mutate(Object.assign({}, options, { mutation,
                variables }));
        });
    }
