...
var Scenario = /** @class */ (function () {
    ...
    Scenario.prototype.makeHttpRegistrationFunction = function (schema) {
        ...
        return function (params) {
            ...
            var completedUrl = new URL(url);
            Object.keys(combinedQueryParams).forEach(function (key) { return url.searchParams.append(key, combinedQueryParams[key]); });
...
function httpGet(url, options) {
    return http(url, __assign({}, options || {}, { method: 'GET' }));
}
exports.httpGet = httpGet;
function httpPost(url, options) {
    return http(url, __assign({}, options || {}, { method: 'POST' }));
}
exports.httpPost = httpPost;
function httpPut(url, options) {
    return http(url, __assign({}, options || {}, { method: 'PUT' }));
}
exports.httpPut = httpPut;
function httpDelete(url, options) {
    return http(url, __assign({}, options || {}, { method: 'DELETE' }));
}
