...
var Scenario = /** @class */ (function () {
    ...
    Scenario.prototype.makeGraphqlRegistrationFunction = function (query) {
        ...
        return function (variables, options) {
            ...
            return _this.client.graphql(query, variables, opts);
        };
    };
    ...
    Scenario.prototype.makeHttpRegistrationFunction = function (schema) {
        ...
        return function (params) {
            ...
            var providedUrlParams = params.urlParams || {};
            delete params.queryParams;
            delete params.urlParams;
            var combinedQueryParams = __assign({}, queryParams, providedQueryParams);
            var hostUrl = _this.client.getHostUrl(host);
            var hasSlash = hostUrl[hostUrl.length - 1] === '/' || path[0] === '/';
            var completedUrl = hostUrl + (hasSlash ? '' : '/') + path;
            Object.keys(providedUrlParams).forEach(function (k) {
